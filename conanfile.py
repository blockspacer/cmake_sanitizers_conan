...
class cmake_sanitizers_conan_project(ConanFile):
    ...
    description = "modified `cmake_sanitizers` library"
    topics = ('c++')
    ...
    def requirements(self):
        self.requires("cmake_helper_utils/master@conan/stable")
    #    if self.options.enable_tests:
    ...
    def package_info(self):
        #self.cpp_info.libs = ["cmake_sanitizers"]
        ...
        #  os.path.join("base", "third_party", "cmake_sanitizers"))
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "cmake_sanitizers", "compat"))
